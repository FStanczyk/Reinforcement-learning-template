...
class Agent:
    def __init__(
        ...
        input_dims_int = input_dims[0] if isinstance(input_dims, tuple) else input_dims
        ...
        self.critic_1 = CriticNetwork(
            beta, input_dims_int, layer1_size, layer2_size, n_actions, name="critic_1"
        )
        self.critic_2 = CriticNetwork(
            beta, input_dims_int, layer1_size, layer2_size, n_actions, name="critic_2"
        )
    ...
    def learn(self):
        ...
        target_actions = T.clamp(
            target_actions, self.min_actions[0], self.max_action[0]
        )
